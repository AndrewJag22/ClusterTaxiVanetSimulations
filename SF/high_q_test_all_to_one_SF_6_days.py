...
script for SF data, 6_days, go Cluster!
...
VANET_dict_filename =  "split_dict_15hrs_onwards_No_Pandas_sf_vanet_dict_combined_6_days.pickle"
Position_dict_filename = "split_dict_15hrs_onwards_No_Pandas_sf_taxis_positions_combined_6_days.pickle"
...
sources_locations_filename = ("%s_random_500_sinks_locations_seed_8008.pickle" % city)

results_data_file_path = ("/export/home/pietro.carnelli/ClusterSetUp-All-to-One/%s-Results/high_q_%i_days/" % (city, num_days))
results_filename = ('%i_sink_id_all_to_1_%s_%i_days_results_high_q.pickle' % (sink_id, city, num_days))
...
min_start_time_seconds = (15*60**2) #(15*60**2) #i.e. 15.00
max_start_time_seconds = (16*60**2) #(16*60**2) #i.e. 16.00
...
# this is a very subtle problem, when a sink is removed from array of sources (see line 118), it changes their index, this little line should in theory, return the sink_id's to their real ids, as listed in the original pickle file.
    if key >= sink_id:
        real_key = key+1
