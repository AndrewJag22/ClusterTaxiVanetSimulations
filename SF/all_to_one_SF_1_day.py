...
script for SF data, 2_days, go Cluster!
...
VANET_dict_filename =  "No_Pandas_CORRECTED_SF_1_day_VANET.pickle"
Position_dict_filename = "No_Pandas_CORRECTED_sf_taxis_positions_combined_1_days.pickle"
...
VANET_dict_filename =  "No_Pandas_CORRECTED_VANET_sf_combined_1_day_daynum_14.pickle"
Position_dict_filename = "No_Pandas_sf_taxis_positions_combined_1_day_day_num_14.pickle"
...
min_start_time_seconds = (16*60**2) #(15*60**2) #i.e. 15.00
max_start_time_seconds = (17*60**2) #(16*60**2) #i.e. 16.00

#simulation_time_limit_hours = 8 #limit at which simulation stops
...
# this is a very subtle problem, when a sink is removed from list of sources, it changes their index, this little line should in theory, return the sink_id's to their real ids, as listed in the original pickle file.
    if key >= sink_id:
        real_key = key+1
