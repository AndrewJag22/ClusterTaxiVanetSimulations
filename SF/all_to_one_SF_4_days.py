...
script for SF data, 4_days, go Cluster!
...
VANET_dict_filename =  "No_Pandas_sf_vanet_dict_combined_4_days.pickle"
Position_dict_filename = "No_Pandas_sf_taxis_positions_combined_4_days.pickle"
...
VANET_dict_filename =  "No_Pandas_CORRECTED_SF_4_days_VANET.pickle"
Position_dict_filename = "No_Pandas_CORRECTED_sf_taxis_positions_combined_4_days.pickle"
...
print('results will be saved to: %s' % (results_data_file_path+results_filename))
